...
Public Class FrmRetiro500

    Private Sub Button12_Click(sender As Object, e As EventArgs)
        FrmMenu.Show()
    End Sub

    Private Sub FrmRetiro500_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Dim conexion As New OleDbConnection
            conexion.ConnectionString = ("PROVIDER=Microsoft.ACE.OLEDB.12.0;Data Source=" & Ruta)
            Dim SentsqlUpdate As String
            SentsqlUpdate = "UPDATE CUENTAS set Saldo=([Saldo]-" & 500 & ") where NOCUENTA=" & NoCuenta
