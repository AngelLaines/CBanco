...
Public Class FrmRetiro1000

    Private Sub Button12_Click(sender As Object, e As EventArgs)
        FrmMenu.Show()
    End Sub

    Private Sub FrmRetiro1000_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Dim conexion As New OleDbConnection
            conexion.ConnectionString = ("PROVIDER=Microsoft.ACE.OLEDB.12.0;Data Source=" & Ruta)
            Dim SentsqlUpdate As String
            SentsqlUpdate = "UPDATE CUENTAS set Saldo=([Saldo]-" & 1000 & ") where NOCUENTA=" & NoCuenta
