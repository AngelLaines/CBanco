...
End Sub
    ...
    Private Sub FrmEntregac_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Dim conexion As New OleDbConnection
            conexion.ConnectionString = ("PROVIDER=Microsoft.ACE.OLEDB.12.0;Data Source=" & Ruta)
            Dim SentsqlUpdate As String
            SentsqlUpdate = "UPDATE CUENTAS set Saldo=([Saldo]-" & saldo & ") where NOCUENTA=" & NoCuenta
