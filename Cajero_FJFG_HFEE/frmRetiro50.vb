...
Public Class frmRetiro50

    Private Sub frmRetiro50_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Dim conexion As New OleDbConnection
            conexion.ConnectionString = ("PROVIDER=Microsoft.ACE.OLEDB.12.0;Data Source=" & Ruta)
            Dim SentsqlUpdate As String
            SentsqlUpdate = "UPDATE CUENTAS set Saldo=([Saldo]-" & 50 & ") where NOCUENTA=" & NoCuenta
    ...
    Private Sub lblDisponible_Click(sender As Object, e As EventArgs) Handles lblDisponible.Click
